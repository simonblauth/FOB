...
def group_parameters_for_adam_plus_wd(model, normalization_weight_decay=False):
...
__all__ = ['AdamPlusWD', 'adampluswd']


class AdamPlusWD(Optimizer):
    def __init__(self,
                 params,
...
def adampluswd(params: List[Tensor],
         grads: List[Tensor],
...
def _multi_tensor_adam(params: List[Tensor],
    ...
    grouped_tensors = Optimizer._group_tensors_by_device_and_dtype(
        [params, grads, exp_avgs, exp_avg_sqs, max_exp_avg_sqs, lrs, lagmuls, kappas, lr_decay_factors, prev_regs, prev_reg_gradients, prev_reg_second_derivatives, state_steps])
    for ((
        device_params,
        device_grads,
        device_exp_avgs,
